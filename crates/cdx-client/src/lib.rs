...
//!
//! [`Client`] turns an ordered series of [`archivindex_cdx::query::Request`] values into CDX server
//! URLs and delegates their capture to [`archivindex_archiver`], retaining exact HTTP request and
//! response bytes in the resulting WARC.
